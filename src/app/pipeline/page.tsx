      ...
      <div className="mb-6 flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            {totalOnBoard === 0
              ...
              : (
                <>
                  <span className="text-blue-600 font-semibold">{totalOnBoard}</span> active application{totalOnBoard === 1 ? '' : 's'} across {PIPELINE_FLAGS.length} stages
                </>
              )}
          </p>
        </div>
        {totalOnBoard > 0 && (
          <button
            ...
            className="inline-flex items-center gap-2 px-3 py-1.5 border border-gray-300 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-50"
      ...
      <div className="flex gap-4 overflow-x-auto pb-4">
        {PIPELINE_FLAGS.map((flagDef, idx) => {
          ...
          return (
            <section
              key={flagDef.key}
              className="flex-shrink-0 w-[280px] bg-gray-50 rounded-xl border border-gray-200 flex flex-col max-h-[calc(100vh-220px)]"
            >
              <header
                className="px-3 py-2.5 border-b border-gray-200 rounded-t-xl"
              ...
              <div className="flex-1 overflow-y-auto p-2 space-y-2">
                ...
                {items.map(({ listing }) => {
                  ...
                  return (
                    <article
                      key={listing.id}
                      className="bg-white rounded-lg border border-gray-200 hover:border-blue-300 hover:shadow-sm p-3 transition-all"
                    >
                      <div className="flex items-start gap-2 mb-1">
                        ...
                        <div className="min-w-0">
                          ...
                          <div className="text-xs text-gray-600 truncate">{listing.company}</div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between gap-1 mt-2">
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          <Link
                            ...
                            className="p-1 rounded text-gray-400 hover:bg-blue-50 hover:text-blue-600"
                            title="Open listing"
                          >
